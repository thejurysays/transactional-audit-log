...
Switch to /plan mode
```
Implement Slice 4 — Persistence

  Scope is exactly what's listed under "Slice 4" in the Implementation Slices section.

  Stop when the deliverable is met.
...
- is there any thing from slice 3 that needs to be updated in the readme.md 
- is there any thing from slice 3 that should have a decision.md entry?
...
# Notes
- is there a way to have the /review explain why the change is needed?